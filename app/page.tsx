...
const linkedin = <LinkedInIcon size={16} className="transition-transform duration-500 group-hover:rotate-[25deg]" />
const slack = <SlackIcon size={16} className="transition-transform duration-500 group-hover:rotate-[25deg]" />
const twitter = <TwitterIcon size={16} className="transition-transform duration-500 group-hover:rotate-[25deg]" />
const mail = <MailIcon size={16} className="transition-transform duration-500 group-hover:rotate-[25deg]" />
const github = <GitHubIcon size={16} className="transition-transform duration-500 group-hover:rotate-[25deg]" />
...
const images = [
    ...
    {
        src: "/photography/centennial.jpg",
        height: 500,
    },
    {
            ...
            <span className="hidden sm:inline-flex gap-1 items-center mb-2">
              Shipping quality software, one line at a time.
                    ...
                    >
                        ...
                        <LeadingButton icon={calendar} text="Calendar" link={"https://calendar.app.google/Yx8PH4GBmrJkwoE3A"} />
                    </motion.div>
                    <motion.div
                ...
                <motion.div initial="hidden" animate="visible" variants={fadeDownVariants}>
                    <Tabs defaultValue="account" className="">
                        ...
                        <TabsContent value="account" className="py-2">
                            ...
                            <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-2" variants={fadeInFromRightVariants}>
